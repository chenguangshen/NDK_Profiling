...
export ANDROID_NDK_ROOT=/Users/cgshen/Downloads/Development/android-ndk-r8b/

# See: http://developer.android.com/guide/appendix/api-levels.html
export ANDROID_API_LEVEL="android-8"

# Run configure script
export PATH=$ANDROID_NDK_ROOT/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86/bin:$PATH
